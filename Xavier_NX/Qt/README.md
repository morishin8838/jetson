...
$sudo rsync -e ssh -avz a8838@192.168.2.99:/lib rootfs/
$sudo rsync -e ssh -avz a8838@192.168.2.99:/sbin rootfs/
$sudo rsync -e ssh -avz a8838@192.168.2.99:/usr/include rootfs/usr
$sudo rsync -e ssh -avz --copy-links --exclude build a8838@192.168.2.99:/usr/lib rootfs/usr
#$sudo rsync -e ssh -avz a8838@192.168.2.99:/usr/bin rootfs/usr
$sudo rsync -e ssh -avz a8838@192.168.2.99:/etc/alternatives rootfs/etc       
$sudo rsync -e ssh -avz a8838@192.168.2.99:/usr/include rootfs/usr
```
